                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> <a href="{{route('admin.vendors.edit', $vendor -> id)}}">  تعديل  {{$vendor -> name}} </a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="form-section"><i class="ft-home"></i>   تحديث بيانات المتجر -  {{$vendor -> name}}   </h4>
                                                ...
                                                <div class = "row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$vendor -> mobile}}"
                                                                   id="mobile"
                                                                   class="form-control"
                                                                   placeholder="    "
                                                                   name="mobile">
