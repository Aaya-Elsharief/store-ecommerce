        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">  العلامات التجارية </h3>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h4 class="form-section">جميع العلامات التجارية </h4>
                                        ...
                                        <table
                                            ...
                                            @isset($brands)
                                                @foreach($brands as $brand)
                                                     <tr>
                                                         <td><img style="width: 100px; height: 100px" src="{{$brand -> logo}}"></td>
                                                         <td>{{$brand -> name}} </td>
