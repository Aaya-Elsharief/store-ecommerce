                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.vendors')}}"> العلامات التجارية </a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{route('admin.vendors.create')}}"> إضافة علامة تجارية </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="form-section"><i class="ft-home"></i> بيانات العلامة التجارية الجديدة </h4>
